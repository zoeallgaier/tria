...
**`supabase/add-chats.sql` (1.7) HAS been run** (probed 2026-09-14: `chats`,
`chat_members`, `messages` and `message_hearts` each answer `200`, where they
...
- **A CAROUSEL is a Frame with 2 to 6 photos** (`posts.images text[]` + `tints
  ...
  height) at full column width like any Frame, ONE card behind it scaled down
  and peeking into the right inset, linear, no dots.
